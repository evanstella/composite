...
int            pgtbl_mapping_mod(pgtbl_t pt, word_t addr, word_t flags, word_t *prevflags);
...
int            chal_pgtbl_mapping_mod(pgtbl_t pt, vaddr_t addr, word_t flags, word_t *prevflags);
